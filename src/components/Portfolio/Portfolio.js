...
const projects = [
  {
    ...
    category: 'Frontend',
    image: process.env.PUBLIC_URL + '/images/portfolio/calculadora.png',
    modalImg: process.env.PUBLIC_URL + '/images/portfolio/modals/m-girl.jpg',
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + '/images/portfolio/coming-soon.jpg',
    modalImg: process.env.PUBLIC_URL + '/images/portfolio/modals/m-console.jpg',
  ...
  },
  {
    ...
    category: 'Coming Soon',
    image: process.env.PUBLIC_URL + '/images/portfolio/coming-soon.jpg',
    modalImg: process.env.PUBLIC_URL + '/images/portfolio/modals/m-coffee.jpg',
  ...
  },
  {
    ...
    category: 'Coming Soon',
    image: process.env.PUBLIC_URL + '/images/portfolio/coming-soon.jpg',
    modalImg: process.env.PUBLIC_URL + '/images/portfolio/modals/m-origami.jpg',
  ...
  },
  {
    ...
    category: 'Coming Soon',
    image: process.env.PUBLIC_URL + '/images/portfolio/coming-soon.jpg',
    modalImg: process.env.PUBLIC_URL + '/images/portfolio/modals/m-judah.jpg',
  ...
  },
  {
    ...
    title: 'Bot Lunch',
    category: 'Coming Soon',
    image: process.env.PUBLIC_URL + '/images/portfolio/bot-lunch.png',
    modalImg: process.env.PUBLIC_URL + '/images/portfolio/modals/m-retrocam.jpg',
